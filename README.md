...
Simple shopping-cart implementation package for Laravel 
...
<br />
Add service provider to 'providers' array in config/app.php <br />Icemix\LaravelShoppingCart\CartServiceProvider::class,
<br />
Add alias to 'aliases' array in config/app.php <br />'Cart' => Icemix\LaravelShoppingCart\Facades\Cart::class,

```shell
php artisan vendor:publish --provider="Icemix\LaravelShoppingCart\CartServiceProvider" --tag="config"
php artisan vendor:publish --provider="Icemix\LaravelShoppingCart\CartServiceProvider" --tag="migrations"
```
...
* [Article](https://icemix.net/post/implementing-a-shopping-cart-in-laravel/)
