...
use Icemix\LaravelShoppingCart\Contracts\Buyable;
...
class Cart
{
     ...
     * @param float     $price
     * @param array     $options
     * @return \Icemix\LaravelShoppingCart\CartItem
     */
    ...
    public function totalSavable($decimals = null, $decimalPoint = null, $thousandSeperator = null)
    {
        $content = $this->getContent();
