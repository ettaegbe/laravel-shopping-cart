...
namespace Icemix\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Icemix\LaravelShoppingCart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Icemix\LaravelShoppingCart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Icemix\LaravelShoppingCart\CartServiceProvider;
use Icemix\Tests\Shoppingcart\Fixtures\ProductModel;
use Icemix\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Icemix\LaravelShoppingCart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Icemix\LaravelShoppingCart\Exceptions\UnknownModelException
     ...
     *
     * @return \Icemix\LaravelShoppingCart\Cart
     */
